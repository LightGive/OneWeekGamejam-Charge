...
public static class SEPath{
	...
	public const string KETTEI_SHOUKETTEISF   = "SE/kettei_shouketteisf";
	public const string NORIMONOHASSHINOOGATA = "SE/norimonohasshinoogata";
	public const string PLAYER_CHARGE         = "SE/PlayerCharge";
	public const string PLAYER_CHARGE1        = "SE/PlayerCharge1";
